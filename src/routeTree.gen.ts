...
export interface FileRoutesByFullPath { '/': typeof IndexRoute; '/author': typeof AuthorRoute; '/playtest': typeof PlaytestRoute; '/characters': typeof CharactersRoute; '/files': typeof FilesRoute; '/knowledge': typeof KnowledgeRoute; '/project': typeof ProjectRoute }
export interface FileRoutesByTo { '/': typeof IndexRoute; '/author': typeof AuthorRoute; '/playtest': typeof PlaytestRoute; '/characters': typeof CharactersRoute; '/files': typeof FilesRoute; '/knowledge': typeof KnowledgeRoute; '/project': typeof ProjectRoute }
export interface FileRoutesById { __root__: typeof rootRouteImport; '/': typeof IndexRoute; '/author': typeof AuthorRoute; '/playtest': typeof PlaytestRoute; '/characters': typeof CharactersRoute; '/files': typeof FilesRoute; '/knowledge': typeof KnowledgeRoute; '/project': typeof ProjectRoute }
export interface FileRouteTypes {
  fileRoutesByFullPath: FileRoutesByFullPath
  fullPaths: '/' | '/author' | '/playtest' | '/characters' | '/files' | '/knowledge' | '/project'
  fileRoutesByTo: FileRoutesByTo
  to: '/' | '/author' | '/playtest' | '/characters' | '/files' | '/knowledge' | '/project'
  id: '__root__' | '/' | '/author' | '/playtest' | '/characters' | '/files' | '/knowledge' | '/project'
  fileRoutesById: FileRoutesById
}
export interface RootRouteChildren { IndexRoute: typeof IndexRoute; AuthorRoute: typeof AuthorRoute; PlaytestRoute: typeof PlaytestRoute; CharactersRoute: typeof CharactersRoute; FilesRoute: typeof FilesRoute; KnowledgeRoute: typeof KnowledgeRoute; ProjectRoute: typeof ProjectRoute }
...
const rootRouteChildren: RootRouteChildren = { IndexRoute, AuthorRoute, PlaytestRoute, CharactersRoute, FilesRoute, KnowledgeRoute, ProjectRoute }
