...
function Overview() {
  ...
  return <section>
    <header className="page-head"><div><p className="eyebrow">Workbench / playable slice</p><h1>Ishar Construction Kit</h1><div className="build-stamp"><strong>Version {__APP_VERSION__}</strong><span>Build {__BUILD_SHA__}</span></div><p>Ein evidenzbasierter Baukasten für neue Ishar-artige RPG-Projekte – mit getrenntem Originaldaten-Audit und eigenem Authoring-Modell.</p></div><div className="toolbar"><Link className="file-button" to="/author">Adventure Builder</Link><button onClick={loadDemo}>Demo-Party laden</button></div></header>
